...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'zinger', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '在这学transformer', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://zinger.com', // 网站地址
